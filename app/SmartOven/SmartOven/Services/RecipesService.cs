...
namespace SmartOvenV2.Services
{
    class RecipesService : IRecipesService
    {
        ...
        public Task FillIngredients(Recipe recipe)
        {
            throw new NotImplementedException();
        }

        public Task FillMethod(Recipe recipe)
        {
            throw new NotImplementedException();
        }

        public Task FillSteps(Recipe recipe)
        {
            throw new NotImplementedException();
        }
...
//    }));
//#endif
            return Task.FromResult(recipes.ToArray());
        }
    }
}
